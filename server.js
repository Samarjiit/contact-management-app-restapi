...
app.use('/api/users', require('./routes/userRoutes')); //act as middleware  it wiill fectch all the routes form routes folder and api/conatacts are the initial path to start
